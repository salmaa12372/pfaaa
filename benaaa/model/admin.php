...
function getTotalAdmins($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM users WHERE role = 'ADMIN'");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}

function getTotalNutritionists($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM users WHERE role = 'NUTRITIONIST'");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}
...
function getOutOfStock($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM products WHERE stock = 0");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}
...
function getBusyLivreurs($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM livreurs WHERE status = 'BUSY'");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}
...
function getTotalReclamations($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM reclamation");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}
...
function getInProgressReclamations($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM reclamation WHERE statut = 'EN_COURS'");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}

function getResolvedReclamations($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM reclamation WHERE statut = 'RESOLU'");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}

function getTotalPayments($cnx) {
    $req = $cnx->prepare("SELECT COUNT(*) as total FROM payments");
    $req->execute();
    $result = $req->fetch();
    return $result['total'];
}
...
function getAllUsersList($cnx) {
    $req = $cnx->prepare("SELECT * FROM users ORDER BY id_user DESC");
    $req->execute();
    return $req->fetchAll();
}
...
function getAllUsinesList($cnx) {
    $req = $cnx->prepare("SELECT * FROM usine");
    $req->execute();
    return $req->fetchAll();
}
